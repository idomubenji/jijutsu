...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'kanji.dex.signin.required': 'You must be signed in to view your kanji collection. Sign in to track your progress and unlock new kanji!',
    ...
    'signin.error': 'An error occurred during sign in. Please try again.',
    ...
    'signup.success': 'Account created successfully! Check your email for the confirmation link.',
    'signup.error': 'An error occurred during signup. Please try again later.',
    'account.created': 'Account created successfully!',
    'check.email': 'Please check your email for the confirmation link to activate your account.',
    'after.confirming': 'After confirming your email, you\'ll be able to sign in to your account.',
  ...
  jp: {
    ...
    'kanji.dex.signin.required': '漢字コレクションを表示するにはログインしてください。ログインして進捗を記録し、新しい漢字のロックを解除しましょう！',
    
    // Authentication
    'sign.in': 'ログイン',
    'sign.up': '登録',
    'sign.in.to.jijutsu': '字術にログイン',
    'create.account': '字術アカウントを作成',
    'email.label': 'メールアドレス',
    'password.label': 'パスワード',
    'email.placeholder': 'あなたの@メール.com',
    'password.placeholder': '••••••••',
    'dont.have.account': 'アカウントをお持ちでない方',
    'signing.in': 'ログイン中...',
    'signing.up': '登録中...',
    'close.button': '閉じる',
    ...
    'signin.success': 'ログインに成功しました！',
    'signin.error': 'ログイン中にエラーが発生しました。もう一度お試しください。',
    'password.min.length': 'パスワードは6文字以上である必要があります',
    'email.exists': 'このメールアドレスのアカウントはすでに存在します。代わりにログインしてください。',
    'signup.success': 'アカウントが正常に作成されました！確認リンクのメールをご確認ください。',
    'signup.error': '登録中にエラーが発生しました。後でもう一度お試しください。',
    'account.created': 'アカウントが正常に作成されました！',
    'check.email': 'アカウントを有効化するために確認リンクのメールをご確認ください。',
    'after.confirming': 'メールを確認した後、アカウントにログインできるようになります。',
