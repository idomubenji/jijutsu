  ...
  return (
    <div className="flex flex-col w-full h-screen bg-[#F2E8DC] dark:bg-[#38332E]">
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-6 px-4 lg:px-8 pb-1">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-auto h-[calc(100vh-10rem)] p-6 order-2 lg:order-1 w-full lg:w-[20%]">
          <DexGrid 
            title="部首図鑑" 
            totalItems={252} 
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-auto h-[calc(100vh-10rem)] p-6 order-1 lg:order-2 w-full lg:w-[80%]">
          <DexGrid 
            title="漢字図鑑" 
            totalItems={6355} 
